package com.xxw.student.view.framework.picker;
...
import com.xxw.student.view.framework.util.DateUtils;
import com.xxw.student.view.framework.widget.WheelView;
...
//            LogUtils.v("select"+year+"年"+month+"月"+day+"日");
        }
    }
    ...
    public String getSelectedYear() {
        System.out.println(years.get(selectedYearIndex));
